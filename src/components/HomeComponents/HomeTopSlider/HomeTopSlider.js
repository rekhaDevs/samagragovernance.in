...
export class HomeTopSlider extends React.Component {
    ...
    resetAnimations = (skip = 0) => {
        ...
        if (skip === 3) {
            this.setState({firstBannerActive: true, secondBannerActive: true, thirdBannerActive: false});
        ...
        if (skip === 2) {
            this.setState({firstBannerActive: true, secondBannerActive: false, thirdBannerActive: false});
    ...
    render() {
        ...
        const {firstBannerActive, showVideo, slideTitleVisible, secondBannerActive, thirdBannerActive, fourthBannerActive} = this.state;
        const allBanners = [];
        let found = false;
        if (this.props.subBanners) {
            ...
            allBanners.splice(0, 0, {active: !!secondBannerActive && !found, id: 3});
        ...
        return (
            <div className={'home-top-slider-wrapper'} style={{background: '#444444'}}>
                <div className="video-background">
                    <video controls={false} muted autoplay="autoplay" loop={true} style={{
                        width: '100%',
                ...
                <HomeTopSliderBannerOne bannerActive={firstBannerActive} banner={this.props.subBanners[0]}/>
                <HomeTopSliderBannerOne bannerActive={secondBannerActive} banner={this.props.subBanners[1]}/>
                <HomeTopSliderBannerOne bannerActive={thirdBannerActive} banner={this.props.subBanners[2]}/>
                {
                    allBanners.length > 1 ?
                        <div className="bubble-wrapper">
                            {
                                allBanners.map((b, index) => {
                                    return <div
                                        ...
                                        className={`navigation-bubble large ${b.active ? 'active' : 'in-active'}`}/>
                                })
                            }
                        </div>
                        : null
