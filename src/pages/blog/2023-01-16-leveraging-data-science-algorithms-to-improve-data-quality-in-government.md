...
**_But, why did we need to collate and match all the farmers’ data in the first place?_** 
...
**_How could we solve this, does the world of data science have some established solutions?_** 
...
_**So, how do the algorithms use these heuristics to come up with the confidence score for each data point?**_ 
...
**_How do we know if this actually worked?_** 
...
**_What happens if the confidence score of a data point goes below the defined threshold?_** 
